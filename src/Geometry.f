...
*
*          integer :: Nx, I
*          double precision :: NPx(1:999),NIx(1:999), Lx, DX
*          double precision :: DelX(1:999), DeltaX(1:999)
*
**         Mesh for X direction
*          if (Nx .GT. 1) then
*            DX = Lx / float(Nx - 1)
...
*        double precision :: Del(0:999,0:999,0:999,1:3)
*
...
*
*        integer :: Nx, I
*        double precision :: NPx(1:999),NIx(1:999), Lx
*        double precision :: DelX(1:999), DeltaX(1:999)
*
